          ...
          >
            <CardHeader className="pb-4">
              <div className="flex items-center justify-between mb-4">
                <div className={`w-12 h-12 rounded-xl flex items-center justify-center bg-${feature.color}/10`}>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex gap-2 pt-2">
                <Button
                  size="sm"
                  className={`flex-1 bg-${feature.color} text-${feature.color}-foreground hover:bg-${feature.color}/90`}
                >
