            ...
            Ok(basic_results) => {
                if basic_results.is_empty() {
                    ...
                    for basic in basic_results {
                        println!("  - {}: {} 个inst_relate记录", basic.refno, basic.inst_relate_count);
                    }
                }
            },
            Err(e) => {
