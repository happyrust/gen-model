...
use crate::grpc_service::types::{ProgressUpdate, TaskStatus, ProgressDetails};
...
pub trait ProgressCallback: Send + Sync {
    ...
    /// 更新详细进度信息
    fn update_progress_with_details(&self, progress: f32, message: String, details: ProgressDetails);
