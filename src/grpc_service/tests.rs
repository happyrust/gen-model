...
mod tests {
    ...
    use crate::grpc_service::types::{ProgressUpdate, TaskStatus, TaskType, TaskRequest, TaskOptions, TaskPriority};
    use crate::grpc_service::auth::{AuthService, AuthConfig};
    use chrono::Utc;
    use std::sync::Arc;
