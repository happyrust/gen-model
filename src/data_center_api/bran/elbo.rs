...
use crate::data_center_api::data_api::{get_bran_itema_attr, get_ispec_from_attr, get_rtext_from_attr, get_spre_material_code};
use crate::data_interface::interface::PdmsDataInterface;
use crate::data_interface::tidb_manager::AiosDBManager;
use crate::graph_db::pdms_arango::ArDatabase;

pub async fn get_data_center_elbo_attr(refno: PdmsElement, bran_name: &str, database: &ArDatabase, aios_mgr: &AiosDBManager) -> Vec<DataCenterAttr> {
