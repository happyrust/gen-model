...
// use story::{
//     AccordionStory, ButtonStory, CalendarStory, DropdownStory, IconStory, ImageStory, InputStory, ListStory, ModalStory, PopupStory, ProgressStory, ResizableStory, ScrollableStory, StoryContainer, SwitchStory, TableStory, TextStory, TooltipStory
// };
use super::app_state::AppState;
use crate::gui::config_panel_story::ConfigPanelStory;
use crate::gui::story;
use crate::gui::story::StoryContainer;
use ui::{
...
impl StoryWorkspace {
    ...
    pub fn new_local(
        ...
        let window_bounds = Bounds::centered(None, size(px(1000.0), px(800.0)), cx);
    ...
    fn render(&mut self, cx: &mut ViewContext<Self>) -> impl IntoElement {
        ...
        div()
            ...
            .child(
                TitleBar::new()
                    // left side
                    .child(div().flex().items_center().child("布置平台控制面板"))
                    .child(
                        div()
                            .flex()
                            .items_center()
