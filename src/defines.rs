...
lazy_static! {
    pub static ref PDMS_ATT_MAP_CACHE: CacheMgr<NamedAttrMap> =
        CacheMgr::new("ATTR_MAP_CACHE", false);
    pub static ref PDMS_ANCESTOR_CACHE: CacheMgr<RefU64Vec> =
        CacheMgr::new("ANCESTOR_CACHE", false);
    pub static ref CACHED_REFNO_BASIC_MAP: CacheMgr<CachedRefBasic> =
        CacheMgr::new("REFNO_BASIC_CACHE", false);
