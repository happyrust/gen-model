...
async fn main() -> Result<()> {
    let m = Command::new("Seed 7999 Demo To Index")
        ...
        .arg(
            Arg::new("index")
                .long("index")
                .required(false)
                .help("索引文件，默认 aabb_cache.sqlite"),
        )
        .get_matches();
    ...
    let path = m
        ...
        .cloned()
        .unwrap_or_else(|| "aabb_cache.sqlite".into());
