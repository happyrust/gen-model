...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("\n📦 插入测试数据...");
    let test_data = vec![
        (RefU64(111200001), create_aabb(0.0, 0.0, 0.0, 100.0, 100.0, 100.0), Some("PIPE_001")),
        (RefU64(111200002), create_aabb(50.0, 50.0, 50.0, 150.0, 150.0, 150.0), Some("VALVE_001")),
        (RefU64(111200003), create_aabb(200.0, 200.0, 200.0, 300.0, 300.0, 300.0), Some("PUMP_001")),
        (RefU64(111200004), create_aabb(-100.0, -100.0, -100.0, 0.0, 0.0, 0.0), Some("TANK_001")),
        (RefU64(111200005), create_aabb(1000.0, 1000.0, 1000.0, 1100.0, 1100.0, 1100.0), Some("EQUIP_001")),
    ];
    ...
    println!("  查询范围: ({:.0}, {:.0}, {:.0}) 到 ({:.0}, {:.0}, {:.0})",
             query_box.mins.x, query_box.mins.y, query_box.mins.z,
             query_box.maxs.x, query_box.maxs.y, query_box.maxs.z);
