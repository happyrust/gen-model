...
| `generating_one_root_fills_geometry_aabb_and_tree` | tests/gen_one_root_probe.rs:90 | 真实项目库；`AIOS_PROBE_DBNUM` / `AIOS_PROBE_ROOT` 可配 | 2026-08-19 @8019 | **通过**：根 `24384/24776` 为 `AlreadyAvailable`，geometry/AABB/tree 均 184→184，空间树 42341 |
