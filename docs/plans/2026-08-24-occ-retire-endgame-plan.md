...
直接读取 E3D 2.1/3.1 安装项目 dabacon 源文件后，已找到 SSCL/SLCY、多面体和 422 个非零
YOFF Snout；E3D 3.1 中 78/78 个直接曲面样本及 4/4 个 POHE 子记录闭包均通过生产网格验证。
35,133,637 个索引元素中仍没有 SPHE，且 T046–T049、双库原子重建尚未执行，因此最终发布
继续按 FR-016 停在球体现场门与维护窗口之前。
